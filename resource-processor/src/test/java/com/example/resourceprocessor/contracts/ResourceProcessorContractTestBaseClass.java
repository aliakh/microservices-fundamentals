...
@AutoConfigureStubRunner(
    repositoryRoot = "stubs://file://song-service/target/stubs",
    ids = "com.example:song-service:1.0-SNAPSHOT",
...
/*
    ...
    public void uploadSongMetadata() {
        ...
        // when
        var response = restTemplate.postForEntity(SONG_BASE_URI, songMetadata, Map.class);
    ...
    public void retrieveSongMetadata() {
        ...
        // when
        var response = restTemplate.getForEntity(SONG_BASE_URI + "/" + SONG_ID, SongDataBuilder.class);
